...
const prizes: Prize[] = [
  { id: 1, name: "恭喜獲得 雞排乙份", emoji: "🍗", rarity: "common" },
  { id: 2, name: "謝謝參與", emoji: "😊", rarity: "common" },
  { id: 3, name: "恭喜獲得 夜市射氣球免費一次", emoji: "🎯", rarity: "rare" },
  { id: 4, name: "再來一次", emoji: "🔄", rarity: "common" },
  { id: 5, name: "恭喜獲得 Switch 遊戲機", emoji: "🕹️", rarity: "legendary" },
  { id: 6, name: "恭喜獲得 珍珠奶茶一杯", emoji: "🧋", rarity: "common" },
  { id: 7, name: "恭喜獲得 夜市大禮包", emoji: "🎁", rarity: "epic" },
  { id: 8, name: "恭喜獲得 章魚燒乙份", emoji: "🐙", rarity: "rare" },
  { id: 9, name: "恭喜獲得 夜市神秘大獎", emoji: "🏆", rarity: "legendary" },
  ...
  { id: 17, name: "恭喜獲得 飛鏢遊戲免費一次", emoji: "🎯", rarity: "common" },
  { id: 18, name: "恭喜獲得 烤玉米乙支", emoji: "🌽", rarity: "rare" },
  { id: 19, name: "謝謝參與", emoji: "🤝", rarity: "common" },
  { id: 20, name: "恭喜獲得 彈珠檯免費玩一次", emoji: "🔮", rarity: "rare" },
  { id: 21, name: "恭喜獲得 煙火棒一組", emoji: "🎆", rarity: "common" },
  { id: 22, name: "恭喜獲得 夜市超級大禮包", emoji: "🌟", rarity: "legendary" },
  { id: 23, name: "恭喜獲得 棉花糖乙份", emoji: "🍭", rarity: "rare" },
  { id: 24, name: "恭喜獲得 雞蛋糕一份", emoji: "🍰", rarity: "common" },
  { id: 25, name: "恭喜獲得 套圈圈免費玩一次", emoji: "⭕", rarity: "rare" },
];
...
export default function ScratchLotteryGame() {
  ...
  const scratchBox = (index: number) => {
    if (scratchedBoxes[index] || scratchingBoxes[index] || gameGrid.length === 0) return;
